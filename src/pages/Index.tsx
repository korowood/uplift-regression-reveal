      ...
      <div className="bg-white shadow-sm border-b sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-800">Uplift Modeling для задач регрессии</h1>
            <p className="text-gray-600">X-learner и специфика регрессионных задач</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-16">
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-xl mb-8">
            ...
            <h2 className="text-3xl font-bold mb-2 text-center">Uplift Modeling</h2>
            <p className="text-xl text-center">Оценка причинно-следственных эффектов в регрессионных задачах</p>
          </div>
        ...
        {/* Section 2: Problems */}
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-bold mb-6 text-center">Основные проблемы регрессионного uplift</h2>
        ...
        {/* Section 3: X-learner Algorithm */}
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6 rounded-xl mb-8">
            <h2 className="text-3xl font-bold mb-2 text-center">X-learner Algorithm</h2>
            <p className="text-center">Четырёхэтапный процесс для оценки индивидуальных эффектов</p>
          </div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    <h4 className="font-semibold mb-2">MODEL3 (для delta1)</h4>
                    <code className="text-sm bg-white p-2 rounded block">
                      X_data_test → MODEL3 → delta1
                    </code>
                  </div>
                  <div className="bg-pink-50 p-4 rounded-lg">
                    <h4 className="font-semibold mb-2">MODEL4 (для delta0)</h4>
                    <code className="text-sm bg-white p-2 rounded block">
                      X_data_control → MODEL4 → delta0
                    </code>
                  </div>
                </div>
              </CardContent>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-bold mb-6 text-center">Математическая формулировка X-learner</h2>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-bold mb-6 text-center">Преимущества X-learner для регрессии</h2>
        ...
        {/* Section 6: Metrics */}
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-bold mb-6 text-center">Метрики оценки качества</h2>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-2xl mb-8">
            <h2 className="text-2xl font-bold mb-4 text-center">Регрессионный Uplift: Итоги</h2>
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-8">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4">
              <div className="text-center">
                <div className="bg-blue-500 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-2 text-sm font-bold">1</div>
                <div className="text-xs max-w-20">Подготовка данных и EDA</div>
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <div className="text-center">
                <div className="bg-green-500 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-2 text-sm font-bold">2</div>
                <div className="text-xs max-w-20">Обучение 4 моделей X-learner</div>
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <div className="text-center">
                <div className="bg-purple-500 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-2 text-sm font-bold">3</div>
                <div className="text-xs max-w-20">Валидация на hold-out</div>
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <div className="text-center">
                <div className="bg-orange-500 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-2 text-sm font-bold">4</div>
                <div className="text-xs max-w-20">A/B тест стратегии</div>
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
              <div className="text-center">
                <div className="bg-red-500 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-2 text-sm font-bold">5</div>
                <div className="text-xs max-w-20">Мониторинг и дообучение</div>
              </div>
            </div>
          </div>
